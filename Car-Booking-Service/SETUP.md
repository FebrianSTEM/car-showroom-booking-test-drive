...
4. Visual Studio will launch the application and open the default browser at the application URL http://localhost:5277/swagger or https://localhost:7126/swagger
