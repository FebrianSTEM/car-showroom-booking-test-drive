...
using user_service.Application.Models.Requests.BookingRequests;
using user_service.Domain.Exception;
using user_service.Domain.Constants;

namespace user_service.Test.Services
{
